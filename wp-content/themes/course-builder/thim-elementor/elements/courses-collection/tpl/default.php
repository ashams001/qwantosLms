		...
		<?php if ( $title || $description || $button_text ) { ?>
			<div class="thim-collection-info">
				<?php if ( $title ):
					...
					<h3 class="title"
						style="<?php echo esc_attr( $title_inline_style ); ?>"><?php echo esc_html( $setting['title'] ); ?></h3>
				...
				<?php if ( $button_text ) :
					...
					<a href="<?php echo esc_url( $archive_collection_url ); ?>"
					   class="view-all-button"><?php echo esc_html( $setting['button_text'] ); ?></a>
				<?php endif; ?>
			</div>
		<?php } ?>
