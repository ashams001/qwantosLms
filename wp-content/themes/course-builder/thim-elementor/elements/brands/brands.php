...
class Thim_Brand_Element extends Widget_Base {
	...
	protected function _register_controls() {
		...
		wp_enqueue_script( 'thim-brands', THIM_URI . 'thim-elementor/elements/' . $this->get_base() . '/assets/js/brands-custom.js', array(
			'jquery',
			'owlcarousel'
		), '', true );
...
Plugin::instance()->widgets_manager->register_widget_type( new Thim_Brand_Element() );