<?php
$user_exits = get_userdata( $setting['id_user'] );
$user_id    = ( $user_exits == true ) ? $setting['id_user'] : 1;
$user       = ( $user_exits == true ) ? get_user_by( 'id', $setting['id_user'] ) : get_user_by( 'id', 1 );
?>
<div class="thim-sc-about-author-course <?php echo esc_attr( $setting['el_class'] ); ?>">
	<h3 class="title">
