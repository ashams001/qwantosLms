...
if ( $params['steps'] ):
	...
	foreach ( $params['steps'] as $key => $step ) {
		...
		$html_nav .= '<p class="tab-title">' . $step['title_step'] . '</p>';
		$html_nav .= '</li>';
	...
	<div class="row">
		...
		<div class="col-md-6 media-box">
			<div class="media-wrapper">
				<?php thim_thumbnail( $params['image']['id'], 'full', 'attachment', false ); ?>
			</div>
		</div>
...
<?php
$background_src = wp_get_attachment_image_src( $params['background_image']['id'], 'full' );
$bg_style       = '';
