...
class Thim_Gallery_Carousel_Element extends Widget_Base {
	...
	protected function _register_controls() {
		...
		wp_register_script( 'thim-gallery-carousel', THIM_URI . 'thim-elementor/elements/' . $this->get_base() . '/assets/js/gallery-carousel-custom.js', array(
			'jquery',
			'owlcarousel'
		), '', true );
...
Plugin::instance()->widgets_manager->register_widget_type( new Thim_Gallery_Carousel_Element() );