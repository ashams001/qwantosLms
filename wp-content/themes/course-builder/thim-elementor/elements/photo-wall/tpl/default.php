<?php
$crop_images = $setting['crop_images'] ? $setting['crop_images'] : 'image-crop';
$crop_sizes  = array();
if ( $crop_images ) {
	$crop_sizes[] = '150x182';
	$crop_sizes[] = '150x126';
...
$mobile_limit = isset( $setting["mobile_limit"] ) ? $setting["mobile_limit"] : '8';
$mobile_title = ( $setting["mobile_title"] ) ? $setting["mobile_title"] : esc_html__( 'View All', 'course-builder' );
$mobile_link  = ( $setting["mobile_link"] ) ? $setting["mobile_link"] : '#';
$class_mobile = 'show_mobile';
$i            = 0;
?>
<div class="thim-sc-photo-wall <?php echo esc_attr( $setting['el_class'] ); ?> ">
					...
					<li class="grid-item <?php echo esc_attr( $class_mobile ); ?>">
						<div class="inner-item">
							<div class="thumbnail">
								...
								thim_thumbnail( $image['image']['id'], $thumbnail_size, 'attachment', false, 'no-lazy' );
								?>
							</div>
							<div class="item-info">
