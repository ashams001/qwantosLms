...
<div class="thim-sc-new-image-box <?php echo $setting['el_class']; ?>">
	<div class="row wrap-image-box">
		<?php foreach ( $setting['image_box'] as $key => $image_box ) :
			...
			<div class="col-md-4 <?php echo esc_attr( $class_columns ); ?>">
				<div class="item">
					<div class="image">
						<?php
						$image_bk = wp_get_attachment_image_src( $image_box['upload_image_background']['id'], '380x283' );
					...
					<div class="content <?php echo $image_box['layout']; ?>">
						<?php
						$image_icon = wp_get_attachment_image_src( $image_box['icon_image']['id'], 'full' );
