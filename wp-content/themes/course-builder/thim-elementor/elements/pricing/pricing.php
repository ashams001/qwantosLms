...
class Thim_Pricing_Element extends Widget_Base {
	...
	protected function _register_controls() {
		...
		wp_register_script( 'thim-sc-pricing', THIM_URI . 'thim-elementor/elements/' . $this->get_base() . '/assets/js/pricing-custom.js', array( 'jquery' ), '', true );
...
Plugin::instance()->widgets_manager->register_widget_type( new Thim_Pricing_Element() );