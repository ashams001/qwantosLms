...
class Thim_Skill_Bar_Element extends Widget_Base {
	...
	protected function _register_controls() {
		...
		wp_register_script( 'thim-sc-skills-bar', THIM_URI . 'thim-elementor/elements/' . $this->get_base() . '/assets/js/skills-bar-custom.js', array(
			'jquery',
			'circle-progress'
		), '', true );
...
Plugin::instance()->widgets_manager->register_widget_type( new Thim_Skill_Bar_Element() );