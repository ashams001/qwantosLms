	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'left'    => [
						'title' => '<img src="' . THIM_URI . 'thim-elementor/elements/' . $this->get_base() . '/assets/images/styles/style-1.jpg' . '">',
						'icon'  => 'bp_el_class'
					],
					'center'  => [
						'title' => '<img src="' . THIM_URI . 'thim-elementor/elements/' . $this->get_base() . '/assets/images/styles/style-2.jpg' . '">',
						'icon'  => 'bp_el_class'
					],
					'style-3' => [
						'title' => '<img src="' . THIM_URI . 'thim-elementor/elements/' . $this->get_base() . '/assets/images/styles/style-3.jpg' . '">',
						'icon'  => 'bp_el_class'
					],
					'style-4' => [
						'title' => '<img src="' . THIM_URI . 'thim-elementor/elements/' . $this->get_base() . '/assets/images/styles/style-4.jpg' . '">',
						'icon'  => 'bp_el_class'
					],
				],
				'default' => 'left',
...
Plugin::instance()->widgets_manager->register_widget_type( new Thim_Text_Box_Element() );