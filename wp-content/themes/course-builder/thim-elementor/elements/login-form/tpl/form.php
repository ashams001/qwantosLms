		...
		<?php if ( get_option( 'users_can_register' ) ) : ?>
			...
			<div class="thim-login">
				...
				<form name="registerform" id="registerform" action="<?php echo esc_url( site_url( 'wp-login.php?action=register', 'login_post' ) ); ?>" method="post" novalidate="novalidate">
                    ...
                    <?php if ( $setting['phone'] == true ) : ?>
                        <p class="htt-phone hide">
                            <input required id="lp_info_phone" type="tel" name="lp_info_phone" class="input lp_info_phone required"/>
                        </p>
                    <?php endif; ?>
                    ...
                    <?php if ( !empty( $setting['term'] ) ): ?>
                        <p>
                            <input type="checkbox" class="term-field required" name="term" id="termFormField">
                            <label for="termFormField"><?php printf( __( 'I accept the <a href="%s" target="%s" rel="%s">Terms of Service</a>', 'course-builder' ), esc_url( $setting['term'] ),'', ''); ?></label>
                        </p>
                    <?php endif; ?>
