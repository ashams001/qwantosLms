...
<table class="form-table">
    ...
    <tr>
        ...
        <td class="zvc-meetings-form">
            <input type="text" name="password" maxlength="10" data-maxlength="9" class="regular-text" value="<?php echo ! empty( $meeting_details->password ) ? esc_html( $meeting_details->password ) : false; ?>">
