...
add_action( 'vczoom_single_content_left', 'video_conference_zoom_countdown_timer', 10 );
add_action( 'vczoom_single_content_left', 'video_conference_zoom_meeting_details', 20 );
add_action( 'vczoom_single_content_left', 'video_conference_zoom_meeting_join', 30 );
add_action( 'vczoom_single_content_left', 'video_conference_zoom_meeting_end_author', 40 );

//Right Section Single Content
//add_action( 'vczoom_single_content_right_sidebar', 'video_conference_zoom_theme_sidebar', 10 );
