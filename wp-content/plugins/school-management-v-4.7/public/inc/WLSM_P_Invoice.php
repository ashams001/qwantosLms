		...
		if ( count( $errors ) < 1 ) {
			...
			try {
				...
				if ( 'razorpay' === $payment_method ) {
					...
					$html = "<button class='wlsm-mt-2 float-right button btn btn-success' id='wlsm-razorpay-btn'>$pay_with_razorpay_text";
					...
					$html = "<button class='wlsm-mt-2 float-right button btn btn-success' id='wlsm-stripe-btn'>$pay_with_paypal_text</button>";
...
<form action="$payment_url" method="post">
	...
	<button type="submit" class='wlsm-mt-2 float-right button btn btn-success' id='wlsm-paypal-btn'>$pay_with_paypal_text</button>
</form>
EOT;
...
EOT;
					...
					$html = "<button class='wlsm-mt-2 float-right button btn btn-success' id='wlsm-paystack-btn'>$pay_with_paystack_text";
