...
<div class="thim-sc-enroll-course  <?php echo esc_attr( $params['el_class'] . '' . $hide_text ); ?>">
    ...
    <div class="learn-press-course-buttons lp-course-buttons">
        ...
        if ( ! $user->has_enrolled_course(  $course->get_id() ) ) {
            ...
            <button class="continue-button"><a href="<?php echo esc_url( get_post_type_archive_link( 'lp_course' ) ); ?>"><?php echo esc_html__('Continue Shopping','course-builder')?></a></button>
        <?php }
