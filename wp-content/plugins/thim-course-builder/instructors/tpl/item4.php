	...
	<div class="item <?php echo esc_attr( $column ); ?> <?php echo esc_attr( $class_columns ); ?>">
		<div class="avatar-item">
			<div class="avatar-instructors">
				...
				$image   = get_avatar( $instructor["user_id"], 680 );
				$pattern = '/src="([^"]*)"/';
				...
				?>
				<?php if ( $image_crop ) { ?>
						<img src="<?php echo esc_url( $image_crop ); ?>" alt="<?php echo get_the_author_meta( 'display_name', $instructor["user_id"] ); ?>" />
				<?php } else { ?>
						<?php echo $image; ?>
				<?php } ?>
				<div class="avartar-info">
					...
					<?php endif; ?>
					<a href="<?php echo learn_press_user_profile_link( $instructor["user_id"] ); ?>"><span><?php echo esc_html__('Read more','course-builder') ?></span><i class="ion-ios-arrow-right"></i></a>
