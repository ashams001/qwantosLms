		...
		public function map() {
			vc_map( array(
				...
				'params'      => array(
					...
					array(
						"type"        => "dropdown",
						"heading"     => esc_attr__( "Select type of style", 'course-builder' ),
						"param_name"  => "style_layout",
						"admin_label" => true,
						"value"       => array(
							esc_attr__( "Default", 'course-builder' )           => "default",
							esc_attr__( "Style Kit Builder", 'course-builder' ) => "style_kit",
						),
						'dependency'  => array(
							'element' => 'box_style',
